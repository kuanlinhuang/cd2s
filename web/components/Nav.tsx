...
export function Nav({ items }: { items: NavItem[] }) {
  ...
  return (
    <div ref={wrap} className="relative ml-auto">
      ...
      {/* A disclosure, not an ARIA menu. role="menu" promises arrow-key navigation
          between items and takes them out of the tab order; these are ordinary links
          a reader tabs through, and claiming the menu pattern without implementing it
          leaves a screen reader announcing a widget that does not behave like one. */}
      {open && (
        <div
          id={panelId}
