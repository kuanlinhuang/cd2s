...
Dataset id: cbio-breast-msk-2025
...
- Median follow-up: 39.4 months (derivable for 3109 cases)
...
- Overall Survival (Months): 99.8% populated (one-to-many)
- Ethnicity: 95.6% informative
- Race: 95.2% informative
...
1. Open the study in cBioPortal (5 minutes)
   ...
   https://www.cbioportal.org/study/summary?id=breast_msk_2025
...
3. Or pull the staging files with git-lfs
   ...
   git -c lfs.fetchexclude="" lfs pull -I public/breast_msk_2025
   ```
...
4. Read the study straight off the REST API
   ...
   ```
   curl -s 'https://www.cbioportal.org/api/studies/breast_msk_2025/clinical-data?clinicalDataType=PATIENT&projection=SUMMARY'
   ```
...
- Full structured record: https://cd2s.vercel.app/data/datasets/cbio-breast-msk-2025.json
