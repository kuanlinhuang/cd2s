...
Dataset id: cbio-brca-mapk-hp-msk-2021
...
- Overall Survival Status: 99.3% informative
- Ethnicity Category: 95.9% informative
- Overall Survival (Months): 95.2% populated (one-to-many)
- Progression Free Status: 93.1% informative
- Race Category: 89.7% informative
- Named therapeutic agents: 24.8% populated (one-to-many)
...
1. Open the study in cBioPortal (5 minutes)
   ...
   https://www.cbioportal.org/study/summary?id=brca_mapk_hp_msk_2021
...
3. Or pull the staging files with git-lfs
   ...
   git -c lfs.fetchexclude="" lfs pull -I public/brca_mapk_hp_msk_2021
   ```
...
4. Read the study straight off the REST API
   ...
   ```
   curl -s 'https://www.cbioportal.org/api/studies/brca_mapk_hp_msk_2021/clinical-data?clinicalDataType=PATIENT&projection=SUMMARY'
   ```
...
- Full structured record: https://cd2s.vercel.app/data/datasets/cbio-brca-mapk-hp-msk-2021.json
