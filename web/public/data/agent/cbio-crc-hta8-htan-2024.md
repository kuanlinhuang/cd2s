# Colorectal Cancer (HTAN MSK, Nature 2025)

Dataset id: cbio-crc-hta8-htan-2024
...
- Tumor Grade: 75.9% informative
- Progress Free Survival (Months): 44.8% populated (one-to-many)
...
1. Open the study in cBioPortal (5 minutes)
   ...
   https://www.cbioportal.org/study/summary?id=crc_hta8_htan_2024
...
3. Or pull the staging files with git-lfs
   ...
   git -c lfs.fetchexclude="" lfs pull -I public/crc_hta8_htan_2024
   ```
...
4. Read the study straight off the REST API
   ...
   ```
   curl -s 'https://www.cbioportal.org/api/studies/crc_hta8_htan_2024/clinical-data?clinicalDataType=PATIENT&projection=SUMMARY'
   ```
...
- Full structured record: https://cd2s.vercel.app/data/datasets/cbio-crc-hta8-htan-2024.json
