...
- Of those, 4 were retrieved and graded individually, and the strongest 4 are kept as exemplars below. Author overlap and funding were resolved for those exemplars only: 3 of the 4 that analyzed the data had no author in common with the generating team, and 1 were themselves NCI funded.
