...
Dataset id: pdc-georgetown-lung-cancer-proteomics-study
...
- Sex at birth (gender): 90.9% informative
- Primary diagnosis: 90.9% informative
- Tissue or organ of origin: 90.9% informative
...
1. Open the study in the PDC portal [human] (5 minutes)
   ...
   https://pdc.cancer.gov/pdc/study/PDC000231
   Policy evidence: https://pdc.cancer.gov/pdc/study/PDC000231
...
3. Resolve the study UUID, then fetch the file manifest [agent]
   filesPerStudy keys on the study UUID, not on PDC000231: called with the pdc_study_id it returns the right number of rows with every column null. Resolve the UUID first and pass the terms acknowledgement.
...
- Full structured record: https://cd2s.vercel.app/data/datasets/pdc-georgetown-lung-cancer-proteomics-study.json
