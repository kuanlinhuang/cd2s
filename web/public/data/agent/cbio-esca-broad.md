...
- Cohort: 151 cases
- Cancer types: Esophageal Adenocarcinoma
...
- Neoplasm Histologic Grade: 99.3% informative
- Sex: 99.3% informative
- Ethnicity Category: 85.4% informative
...
1. Open the study in cBioPortal (5 minutes)
   ...
   https://www.cbioportal.org/study/summary?id=esca_broad
...
3. Or pull the staging files with git-lfs
   ...
   git -c lfs.fetchexclude="" lfs pull -I public/esca_broad
   ```
...
4. Read the study straight off the REST API
   ...
   ```
   curl -s 'https://www.cbioportal.org/api/studies/esca_broad/clinical-data?clinicalDataType=PATIENT&projection=SUMMARY'
   ```
...
- Full structured record: https://cd2s.vercel.app/data/datasets/cbio-esca-broad.json
