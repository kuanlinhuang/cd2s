# Schwannoma (Children's Tumor Foundation, Acta Neuropathologica 2020)

Dataset id: cbio-schw-ctf-synodos-2025
...
1. Open the study in cBioPortal (5 minutes)
   ...
   https://www.cbioportal.org/study/summary?id=schw_ctf_synodos_2025
...
3. Or pull the staging files with git-lfs
   ...
   git -c lfs.fetchexclude="" lfs pull -I public/schw_ctf_synodos_2025
   ```
...
4. Read the study straight off the REST API
   ...
   ```
   curl -s 'https://www.cbioportal.org/api/studies/schw_ctf_synodos_2025/clinical-data?clinicalDataType=PATIENT&projection=SUMMARY'
   ```
...
- Full structured record: https://cd2s.vercel.app/data/datasets/cbio-schw-ctf-synodos-2025.json
