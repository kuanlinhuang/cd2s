...
Dataset id: cbio-paired-bladder-2022
...
- Overall Survival (Months): 93.9% populated (one-to-many)
- Ethnicity Category: 92.5% informative
- Race Category: 92.2% informative
...
1. Open the study in cBioPortal (5 minutes)
   ...
   https://www.cbioportal.org/study/summary?id=paired_bladder_2022
...
3. Or pull the staging files with git-lfs
   ...
   git -c lfs.fetchexclude="" lfs pull -I public/paired_bladder_2022
   ```
...
4. Read the study straight off the REST API
   ...
   ```
   curl -s 'https://www.cbioportal.org/api/studies/paired_bladder_2022/clinical-data?clinicalDataType=PATIENT&projection=SUMMARY'
   ```
...
- Full structured record: https://cd2s.vercel.app/data/datasets/cbio-paired-bladder-2022.json
