...
- Of those, 4 were retrieved and graded individually, and the strongest 4 are kept as exemplars below. Author overlap and funding were resolved for those exemplars only: of the 3 that analyzed the data, 0 had no author in common with the generating team, and 1 were themselves NCI funded.
...
- Full structured record: https://cancer-data-showcase.example.org/data/datasets/pdc-cptac-gbm-discovery-study.json
