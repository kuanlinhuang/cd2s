...
Dataset id: cbio-cellline-ccle-broad
...
- Primary Tumor Site: 92.8% informative
- Sex: 81.9% informative
...
1. Open the study in cBioPortal (5 minutes)
   ...
   https://www.cbioportal.org/study/summary?id=cellline_ccle_broad
...
3. Or pull the staging files with git-lfs
   ...
   git -c lfs.fetchexclude="" lfs pull -I public/cellline_ccle_broad
   ```
...
4. Read the study straight off the REST API
   ...
   ```
   curl -s 'https://www.cbioportal.org/api/studies/cellline_ccle_broad/clinical-data?clinicalDataType=PATIENT&projection=SUMMARY'
   ```
...
- Full structured record: https://cd2s.vercel.app/data/datasets/cbio-cellline-ccle-broad.json
