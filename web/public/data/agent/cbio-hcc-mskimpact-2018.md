...
Dataset id: cbio-hcc-mskimpact-2018
...
- Treatment best response: 63.8% informative
...
1. Open the study in cBioPortal (5 minutes)
   ...
   https://www.cbioportal.org/study/summary?id=hcc_mskimpact_2018
...
3. Or pull the staging files with git-lfs
   ...
   git -c lfs.fetchexclude="" lfs pull -I public/hcc_mskimpact_2018
   ```
...
4. Read the study straight off the REST API
   ...
   ```
   curl -s 'https://www.cbioportal.org/api/studies/hcc_mskimpact_2018/clinical-data?clinicalDataType=PATIENT&projection=SUMMARY'
   ```
...
- Full structured record: https://cd2s.vercel.app/data/datasets/cbio-hcc-mskimpact-2018.json
