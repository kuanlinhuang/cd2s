...
Dataset id: cbio-sarcoma-msk-2023
...
- Median follow-up: 15.6 months (derivable for 80 cases)
...
- Ethnicity Category: 97.6% informative
- Race Category: 97.6% informative
- Overall Survival (Months): 97.6% populated (one-to-many)
...
1. Open the study in cBioPortal (5 minutes)
   ...
   https://www.cbioportal.org/study/summary?id=sarcoma_msk_2023
...
3. Or pull the staging files with git-lfs
   ...
   git -c lfs.fetchexclude="" lfs pull -I public/sarcoma_msk_2023
   ```
...
4. Read the study straight off the REST API
   ...
   ```
   curl -s 'https://www.cbioportal.org/api/studies/sarcoma_msk_2023/clinical-data?clinicalDataType=PATIENT&projection=SUMMARY'
   ```
...
- Full structured record: https://cd2s.vercel.app/data/datasets/cbio-sarcoma-msk-2023.json
