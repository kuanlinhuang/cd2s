...
- Full structured record: https://cancer-data-showcase.example.org/data/datasets/pdc-cptac-kf-ccdi-pediatric-brain-cancer-study-ependymoma-phosphotyrosine.json
