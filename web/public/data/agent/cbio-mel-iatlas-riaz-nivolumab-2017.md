# Melanoma (MSK, Cell 2017) - iAtlas Harmonized

Dataset id: cbio-mel-iatlas-riaz-nivolumab-2017
...
- Response: 91.6% informative
- Overall Survival Status: 90.6% informative
- Overall Survival (Months): 90.6% populated (one-to-many)
- Clinical Benefit: 87.5% informative
- Race: 82.8% informative
- Sex: 82.8% informative
- Clinical Stage: 75.0% informative
...
1. Open the study in cBioPortal (5 minutes)
   ...
   https://www.cbioportal.org/study/summary?id=mel_iatlas_riaz_nivolumab_2017
...
3. Or pull the staging files with git-lfs
   ...
   git -c lfs.fetchexclude="" lfs pull -I public/mel_iatlas_riaz_nivolumab_2017
   ```
...
4. Read the study straight off the REST API
   ...
   ```
   curl -s 'https://www.cbioportal.org/api/studies/mel_iatlas_riaz_nivolumab_2017/clinical-data?clinicalDataType=PATIENT&projection=SUMMARY'
   ```
...
- Full structured record: https://cd2s.vercel.app/data/datasets/cbio-mel-iatlas-riaz-nivolumab-2017.json
