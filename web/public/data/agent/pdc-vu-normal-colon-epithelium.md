# VU Normal Colon Epithelium

Dataset id: pdc-vu-normal-colon-epithelium
...
1. Open the study in the PDC portal [human] (5 minutes)
   ...
   https://pdc.cancer.gov/pdc/study/PDC000278
   Policy evidence: https://pdc.cancer.gov/pdc/study/PDC000278
...
3. Resolve the study UUID, then fetch the file manifest [agent]
   filesPerStudy keys on the study UUID, not on PDC000278: called with the pdc_study_id it returns the right number of rows with every column null. Resolve the UUID first and pass the terms acknowledgement.
...
- Reuse gap index: +1.49 (negative means less reused than comparable datasets)
...
- Full structured record: https://cd2s.vercel.app/data/datasets/pdc-vu-normal-colon-epithelium.json
