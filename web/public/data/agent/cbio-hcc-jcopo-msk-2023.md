...
Dataset id: cbio-hcc-jcopo-msk-2023
...
- Median follow-up: 18.4 months (derivable for 37 cases)
...
- Ethnicity Category: 72.5% informative
- Overall Survival Status: 72.5% informative
- Sex: 72.5% informative
- Overall Survival (Months): 72.5% populated (one-to-many)
- Race Category: 70.6% informative
- Primary Tumor Site: 41.1% informative
...
1. Open the study in cBioPortal (5 minutes)
   ...
   https://www.cbioportal.org/study/summary?id=hcc_jcopo_msk_2023
...
3. Or pull the staging files with git-lfs
   ...
   git -c lfs.fetchexclude="" lfs pull -I public/hcc_jcopo_msk_2023
   ```
...
4. Read the study straight off the REST API
   ...
   ```
   curl -s 'https://www.cbioportal.org/api/studies/hcc_jcopo_msk_2023/clinical-data?clinicalDataType=PATIENT&projection=SUMMARY'
   ```
...
- Full structured record: https://cd2s.vercel.app/data/datasets/cbio-hcc-jcopo-msk-2023.json
