...
- Of those, 22 were retrieved and graded individually, and the strongest 10 are kept as exemplars below. Author overlap and funding were resolved for those exemplars only: of the 10 that analyzed the data, 10 had no author in common with the generating team, and 4 were themselves NCI funded.
...
- Full structured record: https://cancer-data-showcase.example.org/data/datasets/gdc-organoid-pancreatic.json
