...
- Reuse gap index: -2.94 (negative means less reused than comparable datasets)
...
- Full structured record: https://cancer-data-showcase-kuanlinhuangs-projects.vercel.app/data/datasets/gdc-beataml1.0-crenolanib.json
