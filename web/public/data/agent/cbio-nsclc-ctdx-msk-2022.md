...
Dataset id: cbio-nsclc-ctdx-msk-2022
...
- Median follow-up: 16.6 months (derivable for 1127 cases)
...
- Sex: 99.1% informative
- Prior Treatment: 97.8% informative
- Smoking Status: 97.8% informative
- Race Category: 64.4% informative
- Ethnicity Category: 63.8% informative
- Primary Tumor Site: 46.2% informative
...
1. Open the study in cBioPortal (5 minutes)
   ...
   https://www.cbioportal.org/study/summary?id=nsclc_ctdx_msk_2022
...
3. Or pull the staging files with git-lfs
   ...
   git -c lfs.fetchexclude="" lfs pull -I public/nsclc_ctdx_msk_2022
   ```
...
4. Read the study straight off the REST API
   ...
   ```
   curl -s 'https://www.cbioportal.org/api/studies/nsclc_ctdx_msk_2022/clinical-data?clinicalDataType=PATIENT&projection=SUMMARY'
   ```
...
- Full structured record: https://cd2s.vercel.app/data/datasets/cbio-nsclc-ctdx-msk-2022.json
