...
- Of those, 6 were retrieved and graded individually, and the strongest 6 are kept as exemplars below. Author overlap and funding were resolved for those exemplars only: 0 of the 6 that analyzed the data had no author in common with the generating team, and 2 were themselves NCI funded.
