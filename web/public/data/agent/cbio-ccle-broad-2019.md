...
Dataset id: cbio-ccle-broad-2019
...
- Subject: pan cancer
- Measurements: Mutation calls (panel, exome or genome), Copy number alterations, RNA sequencing expression, Mass spectrometry proteomics, Structural variants / fusions
...
- Primary Tumor Site: 61.0% informative
- Ethnicity Category: 59.6% informative
- Sex: 52.6% informative
- Race Category: 33.3% informative
...
3. Or pull the staging files with git-lfs
   ...
   git -c lfs.fetchexclude="" lfs pull -I public/ccle_broad_2019
   ```
...
4. Read the study straight off the REST API
   ...
   ```
   curl -s 'https://www.cbioportal.org/api/studies/ccle_broad_2019/clinical-data?clinicalDataType=PATIENT&projection=SUMMARY'
   ```
...
- Full structured record: https://cd2s.vercel.app/data/datasets/cbio-ccle-broad-2019.json
