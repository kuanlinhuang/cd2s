# Ovarian Cancer (Gray Foundation, Cancer Discov 2024)

Dataset id: cbio-ovary-geomx-gray-foundation-2024
...
- Measurements: RNA sequencing expression
...
1. Open the study in cBioPortal (5 minutes)
   ...
   https://www.cbioportal.org/study/summary?id=ovary_geomx_gray_foundation_2024
...
3. Or pull the staging files with git-lfs
   ...
   git -c lfs.fetchexclude="" lfs pull -I public/ovary_geomx_gray_foundation_2024
   ```
...
4. Read the study straight off the REST API
   ...
   ```
   curl -s 'https://www.cbioportal.org/api/studies/ovary_geomx_gray_foundation_2024/clinical-data?clinicalDataType=PATIENT&projection=SUMMARY'
   ```
...
- Full structured record: https://cd2s.vercel.app/data/datasets/cbio-ovary-geomx-gray-foundation-2024.json
