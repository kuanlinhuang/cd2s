...
- Overall Survival (Months): 99.1% populated (one-to-many)
- Race: 98.0% informative
- Ethnicity: 96.6% informative
- Tumor Stage: 88.0% informative
...
1. Open the study in cBioPortal (5 minutes)
   ...
   https://www.cbioportal.org/study/summary?id=hcc_msk_2024
...
3. Or pull the staging files with git-lfs
   ...
   git -c lfs.fetchexclude="" lfs pull -I public/hcc_msk_2024
   ```
...
4. Read the study straight off the REST API
   ...
   ```
   curl -s 'https://www.cbioportal.org/api/studies/hcc_msk_2024/clinical-data?clinicalDataType=PATIENT&projection=SUMMARY'
   ```
...
- Full structured record: https://cd2s.vercel.app/data/datasets/cbio-hcc-msk-2024.json
