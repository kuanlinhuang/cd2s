# CPTAC CCRCC Confirmatory Study - Intratumor Heterogeneity

Dataset id: pdc-cptac-ccrcc-confirmatory-study-intratumor-heterogeneity
...
- Days to last follow-up: 100.0% populated (one-to-many)
- Ethnicity: 42.5% informative
- Days to death: 30.0% populated (one-to-many)
- Cause of death: 25.0% informative
...
1. Open the study in the PDC portal [human] (5 minutes)
   ...
   https://pdc.cancer.gov/pdc/study/PDC000414
   Policy evidence: https://pdc.cancer.gov/pdc/study/PDC000414
...
3. Resolve the study UUID, then fetch the file manifest [agent]
   filesPerStudy keys on the study UUID, not on PDC000414: called with the pdc_study_id it returns the right number of rows with every column null. Resolve the UUID first and pass the terms acknowledgement.
...
- Full structured record: https://cd2s.vercel.app/data/datasets/pdc-cptac-ccrcc-confirmatory-study-intratumor-heterogeneity.json
