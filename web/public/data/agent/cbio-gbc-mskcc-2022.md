...
Dataset id: cbio-gbc-mskcc-2022
...
- Ethnicity Category: 91.8% informative
- Overall Status: 42.9% informative
- Overall Survival Months: 42.9% populated (one-to-many)
...
1. Open the study in cBioPortal (5 minutes)
   ...
   https://www.cbioportal.org/study/summary?id=gbc_mskcc_2022
...
3. Or pull the staging files with git-lfs
   ...
   git -c lfs.fetchexclude="" lfs pull -I public/gbc_mskcc_2022
   ```
...
4. Read the study straight off the REST API
   ...
   ```
   curl -s 'https://www.cbioportal.org/api/studies/gbc_mskcc_2022/clinical-data?clinicalDataType=PATIENT&projection=SUMMARY'
   ```
...
- Full structured record: https://cd2s.vercel.app/data/datasets/cbio-gbc-mskcc-2022.json
