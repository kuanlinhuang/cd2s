...
- Of those, 9 were retrieved and graded individually, and the strongest 8 are kept as exemplars below. Author overlap and funding were resolved for those exemplars only: of the 7 that analyzed the data, 0 had no author in common with the generating team.
