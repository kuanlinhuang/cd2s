...
Dataset id: cbio-tmb-mskcc-2018
...
- Median follow-up: 11.0 months (derivable for 1661 cases)
...
3. Or pull the staging files with git-lfs
   ...
   git -c lfs.fetchexclude="" lfs pull -I public/tmb_mskcc_2018
   ```
...
4. Read the study straight off the REST API
   ...
   ```
   curl -s 'https://www.cbioportal.org/api/studies/tmb_mskcc_2018/clinical-data?clinicalDataType=PATIENT&projection=SUMMARY'
   ```
...
- Full structured record: https://cd2s.vercel.app/data/datasets/cbio-tmb-mskcc-2018.json
