...
- Disease Free Status: 99.4% informative
- Patient's Vital Status: 99.4% informative
- Disease Free (Months): 82.8% populated (one-to-many)
...
1. Open the study in cBioPortal (5 minutes)
   ...
   https://www.cbioportal.org/study/summary?id=gct_msk_2016
...
3. Or pull the staging files with git-lfs
   ...
   git -c lfs.fetchexclude="" lfs pull -I public/gct_msk_2016
   ```
...
4. Read the study straight off the REST API
   ...
   ```
   curl -s 'https://www.cbioportal.org/api/studies/gct_msk_2016/clinical-data?clinicalDataType=PATIENT&projection=SUMMARY'
   ```
...
- Full structured record: https://cd2s.vercel.app/data/datasets/cbio-gct-msk-2016.json
