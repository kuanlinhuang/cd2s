...
Dataset id: cbio-brain-cptac-2020
...
- DFS Status: 100.0% informative
- Ethnicity: 100.0% informative
- Oncotree Code: 100.0% informative
- OS Status: 100.0% informative
- Race: 100.0% informative
- Sex: 100.0% informative
- DFS Months: 96.5% populated (one-to-many)
- OS Months: 96.5% populated (one-to-many)
...
3. Or pull the staging files with git-lfs
   ...
   git -c lfs.fetchexclude="" lfs pull -I public/brain_cptac_2020
   ```
...
4. Read the study straight off the REST API
   ...
   ```
   curl -s 'https://www.cbioportal.org/api/studies/brain_cptac_2020/clinical-data?clinicalDataType=PATIENT&projection=SUMMARY'
   ```
...
- Full structured record: https://cd2s.vercel.app/data/datasets/cbio-brain-cptac-2020.json
