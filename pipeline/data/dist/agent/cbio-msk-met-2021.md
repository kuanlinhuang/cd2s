...
- Median follow-up: 17.4 months (derivable for 25659 cases)
...
- Primary Tumor Site: 99.1% informative
- Race Category: 94.2% informative
...
3. Or pull the staging files with git-lfs
   ...
   git -c lfs.fetchexclude="" lfs pull -I public/msk_met_2021
   ```
...
4. Read the study straight off the REST API
   ...
   ```
   curl -s 'https://www.cbioportal.org/api/studies/msk_met_2021/clinical-data?clinicalDataType=PATIENT&projection=SUMMARY'
   ```
...
- Full structured record: https://cd2s.vercel.app/data/datasets/cbio-msk-met-2021.json
