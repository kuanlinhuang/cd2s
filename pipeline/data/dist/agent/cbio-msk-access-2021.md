...
Dataset id: cbio-msk-access-2021
...
- Median follow-up: 14.9 months (derivable for 445 cases)
...
- Sex: 99.5% informative
- Oncotree Code: 99.2% informative
- Race Category: 95.6% informative
- Ethnicity Category: 94.2% informative
- Primary Tumor Site: 92.6% informative
- Overall Survival (Months): 72.1% populated (one-to-many)
- Disease Free Status: 0.0% informative
...
1. Open the study in cBioPortal (5 minutes)
   ...
   https://www.cbioportal.org/study/summary?id=msk_access_2021
...
3. Or pull the staging files with git-lfs
   ...
   git -c lfs.fetchexclude="" lfs pull -I public/msk_access_2021
   ```
...
4. Read the study straight off the REST API
   ...
   ```
   curl -s 'https://www.cbioportal.org/api/studies/msk_access_2021/clinical-data?clinicalDataType=PATIENT&projection=SUMMARY'
   ```
...
- Full structured record: https://cd2s.vercel.app/data/datasets/cbio-msk-access-2021.json
