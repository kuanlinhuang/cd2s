...
Dataset id: cbio-sclc-ucologne-2015
...
- Overall Survival Status: 92.5% informative
- Overall Survival (Months): 91.7% populated (one-to-many)
- Smoking History: 61.7% informative
- Ethnicity Category: 55.0% informative
- Progress Free Survival (Months): 35.0% populated (one-to-many)
...
3. Or pull the staging files with git-lfs
   ...
   git -c lfs.fetchexclude="" lfs pull -I public/sclc_ucologne_2015
   ```
...
4. Read the study straight off the REST API
   ...
   ```
   curl -s 'https://www.cbioportal.org/api/studies/sclc_ucologne_2015/clinical-data?clinicalDataType=PATIENT&projection=SUMMARY'
   ```
...
- Full structured record: https://cd2s.vercel.app/data/datasets/cbio-sclc-ucologne-2015.json
