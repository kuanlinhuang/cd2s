...
Dataset id: cbio-blca-mskcc-solit-2014
...
- Race Category: 97.2% informative
- Disease Free Status: 89.9% informative
- Overall Survival Status: 89.9% informative
- Disease Free (Months): 89.9% populated (one-to-many)
- Overall Survival (Months): 89.9% populated (one-to-many)
...
1. Open the study in cBioPortal (5 minutes)
   ...
   https://www.cbioportal.org/study/summary?id=blca_mskcc_solit_2014
...
3. Or pull the staging files with git-lfs
   ...
   git -c lfs.fetchexclude="" lfs pull -I public/blca_mskcc_solit_2014
   ```
...
4. Read the study straight off the REST API
   ...
   ```
   curl -s 'https://www.cbioportal.org/api/studies/blca_mskcc_solit_2014/clinical-data?clinicalDataType=PATIENT&projection=SUMMARY'
   ```
...
- Full structured record: https://cd2s.vercel.app/data/datasets/cbio-blca-mskcc-solit-2014.json
