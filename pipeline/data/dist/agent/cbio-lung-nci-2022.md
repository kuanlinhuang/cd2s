...
- Median follow-up: 49.8 months (derivable for 206 cases)
...
- Tumor Stage: 97.0% informative
- Overall Survival (Months): 88.8% populated (one-to-many)
- Tumor Grade: 84.1% informative
...
1. Open the study in cBioPortal (5 minutes)
   ...
   https://www.cbioportal.org/study/summary?id=lung_nci_2022
...
3. Or pull the staging files with git-lfs
   ...
   git -c lfs.fetchexclude="" lfs pull -I public/lung_nci_2022
   ```
...
4. Read the study straight off the REST API
   ...
   ```
   curl -s 'https://www.cbioportal.org/api/studies/lung_nci_2022/clinical-data?clinicalDataType=PATIENT&projection=SUMMARY'
   ```
...
- Full structured record: https://cd2s.vercel.app/data/datasets/cbio-lung-nci-2022.json
