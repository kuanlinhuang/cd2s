# Cerebrospinal Fluid Circulating Tumor DNA (MSK, Acta Neuropathol Commun 2024)

Dataset id: cbio-csf-msk-2024
...
- Median follow-up: 27.5 months (derivable for 649 cases)
...
- Overall Survival Status: 93.2% informative
- Sex: 93.2% informative
- Overall Survival (Months): 91.3% populated (one-to-many)
...
1. Open the study in cBioPortal (5 minutes)
   ...
   https://www.cbioportal.org/study/summary?id=csf_msk_2024
...
3. Or pull the staging files with git-lfs
   ...
   git -c lfs.fetchexclude="" lfs pull -I public/csf_msk_2024
   ```
...
4. Read the study straight off the REST API
   ...
   ```
   curl -s 'https://www.cbioportal.org/api/studies/csf_msk_2024/clinical-data?clinicalDataType=PATIENT&projection=SUMMARY'
   ```
...
- Full structured record: https://cd2s.vercel.app/data/datasets/cbio-csf-msk-2024.json
