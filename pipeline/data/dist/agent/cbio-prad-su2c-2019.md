...
Dataset id: cbio-prad-su2c-2019
...
- Median follow-up: 19.1 months (derivable for 128 cases)
...
- Race or ethnicity: 90.9% informative
- Overall Survival Status: 29.8% informative
- Overall Survival (Months): 29.8% populated (one-to-many)
...
3. Or pull the staging files with git-lfs
   ...
   git -c lfs.fetchexclude="" lfs pull -I public/prad_su2c_2019
   ```
...
4. Read the study straight off the REST API
   ...
   ```
   curl -s 'https://www.cbioportal.org/api/studies/prad_su2c_2019/clinical-data?clinicalDataType=PATIENT&projection=SUMMARY'
   ```
...
- Full structured record: https://cd2s.vercel.app/data/datasets/cbio-prad-su2c-2019.json
