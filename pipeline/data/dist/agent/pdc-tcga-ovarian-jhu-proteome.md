...
- Of those, 8 were retrieved and graded individually, and the strongest 7 are kept as exemplars below. Author overlap and funding were resolved for those exemplars only: 0 of the 6 that analyzed the data had no author in common with the generating team, and 3 were themselves NCI funded.
...
- Full structured record: https://cancer-data-showcase.example.org/data/datasets/pdc-tcga-ovarian-jhu-proteome.json
