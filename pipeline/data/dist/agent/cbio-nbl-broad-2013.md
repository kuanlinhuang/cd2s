...
Dataset id: cbio-nbl-broad-2013
...
- Median follow-up: 23.9 months (derivable for 240 cases)
...
- Race Category: 92.5% informative
- Ethnicity Category: 88.8% informative
...
1. Open the study in cBioPortal (5 minutes)
   ...
   https://www.cbioportal.org/study/summary?id=nbl_broad_2013
...
3. Or pull the staging files with git-lfs
   ...
   git -c lfs.fetchexclude="" lfs pull -I public/nbl_broad_2013
   ```
...
4. Read the study straight off the REST API
   ...
   ```
   curl -s 'https://www.cbioportal.org/api/studies/nbl_broad_2013/clinical-data?clinicalDataType=PATIENT&projection=SUMMARY'
   ```
...
- Full structured record: https://cd2s.vercel.app/data/datasets/cbio-nbl-broad-2013.json
