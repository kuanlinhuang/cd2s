...
Dataset id: cbio-prad-pik3r1-msk-2021
...
- Median follow-up: 26.3 months (derivable for 1322 cases)
...
- Overall Survival (Months): 93.3% populated (one-to-many)
- Race Category: 92.9% informative
- Ethnicity Category: 90.8% informative
...
3. Or pull the staging files with git-lfs
   ...
   git -c lfs.fetchexclude="" lfs pull -I public/prad_pik3r1_msk_2021
   ```
...
4. Read the study straight off the REST API
   ...
   ```
   curl -s 'https://www.cbioportal.org/api/studies/prad_pik3r1_msk_2021/clinical-data?clinicalDataType=PATIENT&projection=SUMMARY'
   ```
...
- Full structured record: https://cd2s.vercel.app/data/datasets/cbio-prad-pik3r1-msk-2021.json
