...
Dataset id: pdc-tcga-colon-cancer-proteome
...
- AJCC pathologic stage: 97.8% informative
- Prior treatment: 97.8% informative
- Prior malignancy: 97.8% informative
- Classification of tumor: 0.0% informative
- Days to last follow-up: 88.9% populated (one-to-many)
- Days to death: 22.2% populated (one-to-many)
- Race: 7.8% informative
- Ethnicity: 7.8% informative
...
1. Open the study in the PDC portal [human] (5 minutes)
   ...
   https://pdc.cancer.gov/pdc/study/PDC000111
   Policy evidence: https://pdc.cancer.gov/pdc/study/PDC000111
...
3. Resolve the study UUID, then fetch the file manifest [agent]
   filesPerStudy keys on the study UUID, not on PDC000111: called with the pdc_study_id it returns the right number of rows with every column null. Resolve the UUID first and pass the terms acknowledgement.
...
- Full structured record: https://cd2s.vercel.app/data/datasets/pdc-tcga-colon-cancer-proteome.json
