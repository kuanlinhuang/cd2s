...
- Of those, 2 were retrieved and graded individually, and the strongest 1 are kept as exemplars below. Author overlap and funding were resolved for those exemplars only: of the 1 that analyzed the data, 0 had no author in common with the generating team, and 1 were themselves NCI funded.
