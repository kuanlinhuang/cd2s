...
Dataset id: cbio-luad-mskcc-2020
...
- Pathologic Stage: 100.0% informative
- Relapse Free Status: 100.0% informative
- Sex: 100.0% informative
- Smoking History: 100.0% informative
- Overall Survival (Months): 100.0% populated (one-to-many)
- Relapse Free Status (Months): 100.0% populated (one-to-many)
...
1. Open the study in cBioPortal (5 minutes)
   ...
   https://www.cbioportal.org/study/summary?id=luad_mskcc_2020
...
3. Or pull the staging files with git-lfs
   ...
   git -c lfs.fetchexclude="" lfs pull -I public/luad_mskcc_2020
   ```
...
4. Read the study straight off the REST API
   ...
   ```
   curl -s 'https://www.cbioportal.org/api/studies/luad_mskcc_2020/clinical-data?clinicalDataType=PATIENT&projection=SUMMARY'
   ```
...
- Full structured record: https://cd2s.vercel.app/data/datasets/cbio-luad-mskcc-2020.json
