...
- Reuse gap index: -1.10 (negative means less reused than comparable datasets)
...
- Full structured record: https://cancer-data-showcase.example.org/data/datasets/htan-center-for-pediatric-tumor-cell-atlas.json
