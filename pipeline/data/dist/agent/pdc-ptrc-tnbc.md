...
- Of those, 5 were retrieved and graded individually, and the strongest 5 are kept as exemplars below. Author overlap and funding were resolved for those exemplars only: 0 of the 5 that analyzed the data had no author in common with the generating team, and 3 were themselves NCI funded.
