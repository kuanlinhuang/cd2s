...
Dataset id: cbio-gbm-columbia-2019
...
- Median follow-up: 19.1 months (derivable for 42 cases)
...
- Progress Free Survival (Months): 88.1% populated (one-to-many)
- Progression Free Status: 50.0% informative
...
3. Or pull the staging files with git-lfs
   ...
   git -c lfs.fetchexclude="" lfs pull -I public/gbm_columbia_2019
   ```
...
4. Read the study straight off the REST API
   ...
   ```
   curl -s 'https://www.cbioportal.org/api/studies/gbm_columbia_2019/clinical-data?clinicalDataType=PATIENT&projection=SUMMARY'
   ```
...
- Full structured record: https://cd2s.vercel.app/data/datasets/cbio-gbm-columbia-2019.json
