...
Dataset id: htan-breast-pre-cancer-atlas
...
- Measurements: Bulk DNA sequencing, Bulk RNA sequencing, Multiplexed tissue imaging, Single-cell / single-nucleus RNA sequencing
...
- Clinical molecular test: 71.5% populated (one-to-many)
...
- Full structured record: https://cd2s.vercel.app/data/datasets/htan-breast-pre-cancer-atlas.json
