...
Dataset id: cbio-acyc-mskcc-2013
...
- Median follow-up: 14.2 months (derivable for 51 cases)
...
- Disease Free Status: 85.0% informative
- Overall Survival Status: 85.0% informative
- Disease Free (Months): 85.0% populated (one-to-many)
- Overall Survival (Months): 85.0% populated (one-to-many)
...
1. Open the study in cBioPortal (5 minutes)
   ...
   https://www.cbioportal.org/study/summary?id=acyc_mskcc_2013
...
3. Or pull the staging files with git-lfs
   ...
   git -c lfs.fetchexclude="" lfs pull -I public/acyc_mskcc_2013
   ```
...
4. Read the study straight off the REST API
   ...
   ```
   curl -s 'https://www.cbioportal.org/api/studies/acyc_mskcc_2013/clinical-data?clinicalDataType=PATIENT&projection=SUMMARY'
   ```
...
- Full structured record: https://cd2s.vercel.app/data/datasets/cbio-acyc-mskcc-2013.json
