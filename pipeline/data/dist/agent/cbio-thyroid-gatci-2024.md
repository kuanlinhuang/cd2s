...
Dataset id: cbio-thyroid-gatci-2024
...
- Overall Survival: 90.5% informative
- Overall Survival (Months): 89.9% populated (one-to-many)
- Tumor Stage: 52.6% informative
...
1. Open the study in cBioPortal (5 minutes)
   ...
   https://www.cbioportal.org/study/summary?id=thyroid_gatci_2024
...
3. Or pull the staging files with git-lfs
   ...
   git -c lfs.fetchexclude="" lfs pull -I public/thyroid_gatci_2024
   ```
...
4. Read the study straight off the REST API
   ...
   ```
   curl -s 'https://www.cbioportal.org/api/studies/thyroid_gatci_2024/clinical-data?clinicalDataType=PATIENT&projection=SUMMARY'
   ```
...
- Full structured record: https://cd2s.vercel.app/data/datasets/cbio-thyroid-gatci-2024.json
